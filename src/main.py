...
def evaluate(args, model, tokenizer, question, html_code):
    ...
    Evaluate the model
    """
    dataset, examples, features = load_and_cache_examples(args, tokenizer, question, html_code)
...
def load_and_cache_examples(args, tokenizer, question, html_code):
    examples = read_simple_examples(question, html_code, tokenizer, args.method)
